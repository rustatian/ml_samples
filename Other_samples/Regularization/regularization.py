...
import scipy.io
from Other_samples.Regularization.testCases import *
...
predictions_train_l2 = predict(train_X, train_Y, parameters)
print("On the test set:")
predictions_test_l2 = predict(test_X, test_Y, parameters)
...
print("On the train set:")
predictions_train_dr = predict(train_X, train_Y, parameters)
print("On the test set:")
predictions_test_dr = predict(test_X, test_Y, parameters)
